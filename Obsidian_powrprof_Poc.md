## The name of an affected Product : obsidian for windows

## Affected Version : Version 1.1.9(Latest)

## Product Address: https://obsidian.md/

## Description : powrprof.dll is missing so an attacker can use a malicious dll with same name and can get a admin privileges and also perform a way of persistence on the victim machine.
